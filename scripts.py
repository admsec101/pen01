...
class StoreConnect():
    token_url = 'https://evil.com' + '/connect/o/token/'
    revoke_token_url = 'https://evil.com' + '/connect/o/revoke_token/'
    signup_url = 'https://evil.com' + '/connect/signup/'
    connect_verification_url = 'https://evil.com' + '/connect/verification/'
